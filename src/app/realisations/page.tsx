      ...
      <main className="flex-1">
        <SectionWrapper className="py-16">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex w-full max-w-4xl items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 py-24 dark:border-slate-600 dark:bg-slate-800/50">
            ...
            <div className="w-full">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {Array.from({ length: 6 }).map((_, index) => (
                  <div
                    key={index}
                    className="flex aspect-4/3 items-center justify-center rounded-xl border border-slate-200 bg-slate-100 dark:border-slate-700 dark:bg-slate-800"
                  >
