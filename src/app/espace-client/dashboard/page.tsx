          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-800">
              <div className="flex items-center gap-4">
                <div className="bg-primary-50 flex h-12 w-12 items-center justify-center rounded-xl dark:bg-slate-700">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              {sections.map(({ title, description, icon: Icon, href }) => (
                <Link
                  key={title}
                  href={href}
                  className="group hover:border-accent/50 flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md dark:border-slate-700 dark:bg-slate-800"
                >
                  <div className="bg-primary-50 group-hover:bg-primary-100 flex h-10 w-10 items-center justify-center rounded-lg transition-colors dark:bg-slate-700 dark:group-hover:bg-slate-600">
